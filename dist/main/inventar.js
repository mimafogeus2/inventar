...
var createTuplesFromTransformers = function (valueTuple, _a) {
    ...
    var transformerFunction = isTransformerObject(currentTransformer)
...
var resolveTuple = function (config, name, value) { return [
    resolve(config, name),
...
var makeInventar = function (config, options) {
    ...
    var cssInventarObject = optionsWithDefaults.shouldMakeCssInventar
