System.register(['tslib'], function (exports) {
  'use strict';
  var __assign, __spreadArrays;
  return {
    ...
    execute: function () {
      ...
      var camelCase2KebabCase = exports('camelCase2KebabCase', function (str) { return str.replace(/([a-z0-9]|(?=[A-Z]))([A-Z])/g, '$1-$2').toLowerCase(); });
      var cssVars2StyleString = function (config) { return (Object.entries(config).map(function (_a) {
          var name = _a[0], value = _a[1];
          return name + ": " + value;
      }).join(';')); };
      var injectToStyle = exports('injectToStyle', function (formattedConfig, domEl) {
          var styleString = cssVars2StyleString(formattedConfig);
          domEl.setAttribute('style', styleString);
      });
      var injectToRoot = exports('injectToRoot', function (formattedConfig) {
      ...
      var isDerivative = exports('isDerivative', function (val) { return (val === null || val === void 0 ? void 0 : val.constructor) === Function; });
      var isValueObject = exports('isValueObject', function (val) { return (val === null || val === void 0 ? void 0 : val.value) !== undefined; });
      ...
      var isEntryTuple = exports('isEntryTuple', function (val) { return (val === null || val === void 0 ? void 0 : val.constructor) === Array
          && val.length === 2
          && isFieldName(val[0])
          && isValue(val[1]); });
      ...
      var makeInventar = exports('default', function (config, options) {
          if (options === void 0) { options = {}; }
